...
public class Generator {
    ...
    String[] countries = {
            ...
            "Mexico", "Brazil", "Argentina", "Monaco", "Cuba", "India", "Belgium","China", "Japan", "SUA", "Canada",
            "Germany", "Italy", "Serbia", "Ukraina", "Russia", "Switzerland", "Latvia"
    };

    String[] albums = {
            "Nowhere", "Never let you go", "Let you go", "Rising stars", "Stars","Do not leave", "Close to me", "Run", "Run away", "Running",
            "Falling", "Never back down", "Insanity", "Interstellar", "Insane", "Crazy", "Go away", "Come back",
            "See you again", "Stay", "Keep you", "Galaxy"
    };
